...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import React, { PureComponent, createRef } from 'react'
...
&nbsp;
    _watchKeyboard = e =&gt; {
        e = e || <span class="branch-1 cbranch-no" title="branch not covered" >window.event</span>
        const KEY_TAB = 9
        const KEY_ESC = 27
...
&nbsp;
        <span class="missing-if-branch" title="else path not taken" >E</span>if (e.keyCode === KEY_ESC &amp;&amp; closeOnEsc) {
...
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (e.shiftKey &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >currEl === firstEl)</span> {
<span class="cstat-no" title="statement not covered" >            e.preventDefault()</span>
<span class="cstat-no" title="statement not covered" >            lastEl.focus()</span>
<span class="cstat-no" title="statement not covered" >            return</span>
        }
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!e.shiftKey &amp;&amp; currEl === lastEl) {
<span class="cstat-no" title="statement not covered" >            e.preventDefault()</span>
<span class="cstat-no" title="statement not covered" >            firstEl.focus()</span>
<span class="cstat-no" title="statement not covered" >            return</span>
        }
&nbsp;
        const isValidEl = Array.from(focusable).find(el =&gt; el === currEl)
        <span class="missing-if-branch" title="else path not taken" >E</span>if (!isValidEl) {
            e.preventDefault()
            firstEl.focus()
        }
    }
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Tue Jul 09 2019 12:31:53 GMT+0100 (Western European Summer Time)
</div>
</div>
